...
<svelte:head>
	<title>{meta.title} - Brandon Touchet blog</title>
	...
	<meta property="og:image" content="https://randombrandles.com{imagePath}" />
	<meta property="og:image:width" content={meta.coverWidth} />
	<meta property="og:image:height" content={meta.coverHeight} />
	<meta name="twitter:image" content="https://randombrandles.com{imagePath}" />
	<meta property="og:url" content="https://randombrandles.com/blog/{meta.slug}/" />
</svelte:head>
